...
class mat:
    ...
    def ones(n):
        '''
        返回一个n维的单位矩阵
        :param n:如果是整数，则是n维的单位矩阵，元组则为全为1的矩阵
        :return:
        '''
        if isinstance(n, int):
            I = [None] * n
...
if __name__ == '__main__':
    ...
    # , [1, 2, 5, 1, 4, 3, -4, 1, 10, 0], [11, 2, 6, 12, 4, 5, -4, 1, 11, 0],
    #             [0, 11, 2, 11, 3, 4, 0, 9, 7, 7],
    #             [4, 11, 2, 21, 3, 8, 4, 9, 7, 17],[43,11,21,-1,3,8,-4,9,7,7],[23,11,-1,-1,3,8,-4,9,7,17],[-41,16,21,-1,5,8,-4,9,7,7],
    #             [0, 2, 6, 12, 4, 3, -4, 1, -1, 0], [0, 2, 15, 1, 4, 13, -4, 1, 10, 0], [11, 22, 6, 12, 4, 35, -4, 1, 11, 0],
    #             [0, 12, 2, 11, 3, 54, 10, 9, 7, 7],
    #             [41, 101, 21, 21, 3, 8, 40, 9, 7, 17], [43, 11, 21, -1, 31, 8, -42, 9, 17, 7], [23, 11, -11, -1, 13, 8, -41, 9, 7, 17],
    #             [-4, 16, 1, -1, 5, 8, 56, 9, 71, 7],[-5, 16, 1, -1, 51, 8, 56, 91, 71, 7],[-4, 0, 1, -1, 0, 8, 56, 4, 71, 7],
    #            [-4, 15, 1, -1, -5, 81, 56, 9, 71, 7]

    a = [[1, 2], [1, 4], [3, 2], [25, 10]]
    b1 = [[3, 6, 9], [2, 3, 4], [1, 3, 6]]
    b2 = [[3, 6, 9, 3, 1], [2, 3, 4, 1, 1], [2, 1, 2, 5, 2], [2, 3, 1, 8, 4], [3, 6, 9, 3, 8]]
    c = [[0.5, 1, 0], [2, 1.5, 1], [0.2, 1, 2.5]]
    d = [[2, 5, -6], [4, 13, -19], [-6, -3, -6]]
